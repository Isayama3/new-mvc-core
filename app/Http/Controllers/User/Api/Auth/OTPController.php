...
class OTPController
{
    ...
    public function sendOTP(SendOTPRequest $request)
    {
        ...
        return $this->shortSuccess(msg: __('user.otp_send_successfully'));
    }
    ...
    public function verifyOTP(VerifyOTPRequest $request)
    {
        ...
        if (!$otp)
            return $this->ErrorMessage(msg: __('user.invalid_otp'));

        if ($otp->valid_until < Carbon::now())
            return $this->ErrorMessage(msg: __('user.expired_otp.'));
        ...
        return $this->shortSuccess(
            ...
            msg: __('user.otp_verified_successfully.')
        );
    }
}
