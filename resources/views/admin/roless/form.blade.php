{!! \App\MyApp\Base\Helper\Field::text('name' , __('اسم الصلاحية') )!!}
{{--{!! \App\MyApp\Base\Helper\Field::text('display_name' , __('الاسم المعروض') ) !!}--}}
{!! \App\MyApp\Base\Helper\Field::textarea('description' , __('الوصف') ) !!}
<br>
